...
public class ControllerChannelHandler extends OFChannelHandler {
    ...
    enum ChannelState {
        ...
        protected String getControllerStateMessage(
            ...
            //h.log.info("Traffic Count info : {}",h.tc.getLastReadBytes());
        ...
        void processOFMessage(final ControllerChannelHandler h,
        	...
        	//h.tc = h.ctrl.makeCounter();
            switch (m.getOFMessage().getType()) {
                case HELLO:
                    this.processOFHello(h, m);
                    //h.log.info("Hello_Traffic Count info : {} / {}",h.tc.getCurrentWrittenBytes(),h.tc.getCurrentReadBytes());
                    break;
                case ECHO_REPLY:
                    this.processOFEchoReply(h, m);
                    //h.log.info("EchoReplay_Traffic Count info : {}",h.tc.getLastReadBytes());
                    break;
                case ECHO_REQUEST:
                    this.processOFEchoRequest(h, m);
                    //h.log.info("EchoRequest_Traffic Count info : {}",h.tc.getLastReadBytes());
                    break;
                case ERROR:
                    this.processOFError(h, m);
                    //h.log.info("Error_Traffic Count info : {}",h.tc.getLastReadBytes());
                    break;
                case EXPERIMENTER:
                    ...
                    //h.log.info("Experimenter_Traffic Count info : {}",h.tc.getLastReadBytes());
                    break;
                case ROLE_REQUEST:
                ...
                case FLOW_MOD:
                    ...
                    //h.log.info("FlowMod_Traffic Count info : {}",h.tc.getLastReadBytes());
                    break;
                case GET_CONFIG_REQUEST:
...
//                                    this.log.info("tenantId = " + tenantId);
                                    ...
                                    OVXMap.getInstance()
                                     ...
                                     //trafficCounter
                                    //System.out.print(this.tc.getLastReadThroughput());
                                    break;
                                }
                            }
                        default:
        ...
        //this.log.info("dddddddd: {}, switchId: {}", ctx.getName(), this.sw.getSwitchName());
        //trafficCounter
        //System.out.print(this.tc.getLastReadThroughput());
    }
