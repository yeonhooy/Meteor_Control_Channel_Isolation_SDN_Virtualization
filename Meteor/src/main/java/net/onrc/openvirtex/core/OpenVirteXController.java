...
public class OpenVirteXController implements Runnable {
    ...
    public static int[][] channelList = new int[100][300];
    //public static ChannelPipeline[][] channelList = new ChannelPipeline [100][300];
    ...
    //private TrafficCounter tc = null;

    public static int maxVirtual = 0;
    ...
    public void addControllers(final OVXSwitch sw, final Set<String> ctrls) {
        ...
        for (String ctrl : ctrls) {
            ...
            //this.tc = this.cfact.makeTrafficCounter();
            ...
            //log.info("****print channel pipeline monitoring(tostring): {}",cfact.toString());
            //log.info("please read Throughput: {}", tc.getLastReadThroughput());
        }
    }
...
//        OFNiciraVendorExtensions.initialize();
    ...
    /*public TrafficCounter makeCounter(){
    	this.log.info("return traffic counter: {}",this.cfact.makeTrafficCounter());
    	return this.cfact.makeTrafficCounter();
    }*/
   
   /* public void monitoringChannel(){
    	//TrafficCounter counter = this.clientChannelShapingHandler.getTrafficCounter();
        //this.tc = this.cfact.makeTrafficCounter();
        TrafficCounter counter = this.cfact.makeTrafficCounter();
        ...
        long lastReads = counter.getLastReadBytes();
        long lastWrites = counter.getLastWrittenBytes();
