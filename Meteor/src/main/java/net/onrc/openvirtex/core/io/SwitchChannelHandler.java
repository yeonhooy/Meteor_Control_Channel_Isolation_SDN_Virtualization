...
//                    case VENDOR:
        ...
        void processOFMessage(final SwitchChannelHandler h, final OVXMessage m)
             ...
             switch (m.getOFMessage().getType()) {
                case HELLO:
                    h.log.info("processOFmessage_HELLO");
                    this.processOFHello(h, m);
                    break;
                case BARRIER_REPLY:
                    h.log.info("processOFmessage_BARRIER_REPLY");
                    this.processOFBarrierReply(h, m);
                    break;
                case ECHO_REPLY:
                    h.log.info("processOFmessage_ECHO_REPLY");
                    this.processOFEchoReply(h, m);
                    break;
                case ECHO_REQUEST:
                    h.log.info("processOFmessage_ECHO_REQUEST");
                    this.processOFEchoRequest(h, m);
                    break;
                case ERROR:
                    h.log.info("processOFmessage_ERROR");
                    this.processOFError(h, m);
                    break;
                case FEATURES_REPLY:
                    h.log.info("processOFmessage_FEATURES_REPLY");
                    this.processOFFeaturesReply(h, m);
                    break;
                case FLOW_REMOVED:
                    h.log.info("processOFmessage_FLOW_REMOVED");
                    this.processOFFlowRemoved(h, m);
                    break;
                case GET_CONFIG_REPLY:
                    h.log.info("processOFmessage_GET_CONFIG_REPLY");
                    this.processOFGetConfigReply(h, m);
                    break;
                case PACKET_IN:
                    h.log.info("processOFmessage_PACKET_IN");
                    this.processOFPacketIn(h, m);
                    break;
                case PORT_STATUS:
                    h.log.info("processOFmessage_PORT_STATUS");
                    this.processOFPortStatus(h, m);
                    break;
                case QUEUE_GET_CONFIG_REPLY:
                    h.log.info("processOFmessage_QUEUE_GET_CONFIG_REPLY");
                    this.processOFQueueGetConfigReply(h, m);
                    break;
                case STATS_REPLY:
                    h.log.info("processOFmessage_STATS_REPLY");
